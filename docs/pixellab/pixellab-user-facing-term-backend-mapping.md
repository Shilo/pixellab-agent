...
- Characters: `/create-character-with-4-directions`, `/create-character-with-8-directions`, `/create-character-pro`, `/create-character-v3`, `/portrait-character-pro`, `/create-character-state`, `/animate-character`, `/characters/animations`, plus character list/get/delete/tag/zip.
...
- Character: `create_character`, `create_portrait_character`, `get_portrait_character`, `create_character_state`, `animate_character`, `get_character`, `list_characters`, `delete_character`, `delete_animation`.
- Fonts: `create_font`, `get_font`.
...
| `Generate pixel font (Pro)` / pixel font / bitmap font | `POST /generate-font-pro` | `create_font`, `get_font` | None reviewed beyond public docs in this update | Pro font generation | Public REST/MCP | High. Evidence: OpenAPI and llms list `/v2/generate-font-pro`; MCP docs list `create_font` and `get_font`. |
...
| `Portrait to character` / `Character to portrait` | `POST /portrait-character-pro` | `create_portrait_character`, `get_portrait_character` | None reviewed beyond public docs in this update | Pro portrait-character conversion | Public REST/MCP | High. Evidence: OpenAPI and llms list `/v2/portrait-character-pro`; MCP docs list `create_portrait_character` and `get_portrait_character`. |
