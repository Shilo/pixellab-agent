...
| Pixelorama/editor | Browser editor surface used for editing/saving assets. | Visible editor assistance, manual edits, and save-back flows after permission. | Ask before browser use and again before login, generation, spending credits, save/download/edit/delete actions. |
