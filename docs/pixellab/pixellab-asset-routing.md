...
| Unzoom pixel art | Aseprite or Pixelorama extension. | No public REST v2 or MCP Unzoom endpoint was documented; use local tooling only as a labeled non-PixelLab fallback after explaining the PixelLab route is extension-only. |
